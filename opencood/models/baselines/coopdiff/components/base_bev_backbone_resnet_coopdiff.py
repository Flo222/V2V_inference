...
from opencood.models.baselines.coopdiff.components.resblock_coopdiff import (BasicBlock, Bottleneck,
                                                  ResNetModified)

from opencood.models.baselines.coopdiff.components.res2net_coopdiff import Res2Net,Bottle2neck
DEBUG = False
