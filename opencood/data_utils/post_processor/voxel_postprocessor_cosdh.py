...
class VoxelPostprocessorCosdh(BasePostprocessor):
    def __init__(self, anchor_params, train):
        super(VoxelPostprocessorCosdh, self).__init__(anchor_params, train)
    ...
    def post_process(self, data_dict, output_dict, confidence_beta=None, confidence_threshold=None):
        """
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            # apply confidence-aware late fusion
