...
class VoxelPostprocessorV2XReal(BasePostprocessor):
    ...
    def post_process(self, data_dict, output_dict, projection=True,
        ...
        # Some predicted boxes can be filtered as too large or abnormal in z.
        # This is valid during inference, especially for newly trained or migrated models.
        # Do not assert all boxes are kept; just filter them.
        if keep_index.sum().item() == 0:
            return None, None
